package com.example.almin.flixster;
...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyCdJ1s_RtFx8OyhF2E1jJ6lKQ-Ez_rM2Wc";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (movie.isAdult()) {
            adult.setText("Adult Movie");
        }
        else {
            adult.setText("Not an Adult Movie");
        }
